...
// gcc -Wall -Werror -Wextra -pedantic -std=c99 -c array_helpers.c fixstring.c sort_helpers.c sort.c main.c
// gcc -Wall -Werror -Wextra -pedantic -std=c99 -no-pie array_helpers.o fixstring.o sort_helpers.o sort.o main.o -o word_sorter