 ...
 *Agrega el elemento 'e' a la pqueue 'q' con la 'prioridad' dada
 * PRE: {q --> pqueue}
 ...
 *Indica si la pqueue 'q' está vacía o no
 */

unsigned int pqueue_size(pqueue q);
/*
 * DESC: Return the number of elements inside the pqueue 'q'
 *Devuelve el número de elementos dentro de la pqueue 'q'
 */

pqueue_elem pqueue_peek(pqueue q);
/*
 * DESC: Return the element with the most urgent prioritiy of the pqueue 'q'
 *Devuelve el elemento con la prioridad más urgente de la pqueue 'q'
 ...
 *Devuelve el promedio_grado que es más urgente de la pqueue 'q'
 * PRE: {q --> pqueue && !pqueue_is_empty(q)}
 ...
 *Devuelve los cursos_aprobados que son más urgentes de la pqueue 'q'
 * PRE: {q --> pqueue && !pqueue_is_empty(q)}
 ...
 *Devuelve la prioridad que es más urgente de la pqueue 'q'
 ...
 * DESC: Remove the element with the most urgent priority of the pqueue 'q'
 Eliminar el elemento con la prioridad más urgente de la pqueue 'q'
 *
 * PRE: {q --> pqueue && !pqueue_is_empty(q)}
 *  q = pqueue_dequeue(q);
 * POS: {q --> pqueue}
 ...
 *Destruye la instancia de pqueue, liberando toda la memoria utilizada por 'q'.
 * PRE: {q --> pqueue}
 *  q = pqueue_destroy(q);
 * POS: {q == NULL}
 *
